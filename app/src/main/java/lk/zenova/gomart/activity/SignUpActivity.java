...
import lk.zenova.gomart.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.signuptextSignin.setOnClickListener(v -> {
        ...
        binding.signupBtnSignup.setOnClickListener(view -> {
            ...
            String mobile = binding.signupInputMobile.getText().toString().trim();
            ...
            if (mobile.isEmpty()) {
                binding.signupInputMobile.setError("Mobile is required");
                binding.signupInputMobile.requestFocus();
                return;
            }

            if (!Patterns.PHONE.matcher(mobile).matches()) {
                binding.signupInputMobile.setError("Enter valid mobile number");
                binding.signupInputMobile.requestFocus();
                return;
            }
            ...
            firebaseAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        User user = User.builder().uid(uid).name(name).email(email).mobile(mobile).build();
