        ...
        if (imageUrl != null && !imageUrl.isEmpty()) {
            if (imageUrl.startsWith("https://") || imageUrl.startsWith("http://")) {
                Glide.with(holder.itemView.getContext())
                        ...
                        .error(R.drawable.shopping_cart_unfilled)
                ...
                storage.getReference(imageUrl)
                        ...
                        .addOnFailureListener(e -> {
                            Log.e("CategoryAdapter", "Image load failed: " + e.getMessage());
                            holder.categoryImage.setImageResource(R.drawable.shopping_cart_24);
                        });
            }
        } else {
            Log.w("CategoryAdapter", "imageUrl is null or empty for: " + category.getName());
            holder.categoryImage.setImageResource(R.drawable.shopping_cart_24);
        }
